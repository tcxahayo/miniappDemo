...
var RefundCard = (_temp2 = _class = function (_BaseComponent) {
  ...
  function RefundCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RefundCard.__proto__ || Object.getPrototypeOf(RefundCard)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp2", "anonymousState__temp3", "loopArray28", "anonymousState__temp4", "anonymousState__temp5", "trade", "anonymousState__temp", "REFUND_TABS", "$anonymousCallee__3", "activeTabKey"], _this.goRefundDetail = function (refund) {}, _this.customComponents = ["OrderCard"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(RefundCard, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = trade.refund.refund_remind_timeout ? this._createcountDownData(__prefix + "eazzzzzzzz")(trade.refund.refund_remind_timeout.timeout) : null;
      ...
      var $anonymousCallee__3 = (0, _resolveTopResponse.getOrders)(trade);
      var anonymousState__temp4 = { text: trade.buyer_nick, msg: '复制成功' };
      var anonymousState__temp5 = { text: trade.refund.refund_id, msg: '复制成功' };
      var loopArray28 = (0, _resolveTopResponse.getOrders)(trade).map(function (order, _anonIdx) {
        order = {
          $original: (0, _index.internal_get_original)(order)
        };

        var _genCompid = (0, _index.genCompid)(__prefix + "ebzzzzzzzz" + _anonIdx, true),
