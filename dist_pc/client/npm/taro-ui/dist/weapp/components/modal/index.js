...
var _index5 = require("../../../../../_tarojs/taro-alipay/index.js");
...
var AtModal = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtModal, [{
    ...
    value: function _constructor(props) {
      ...
      this.state = {
        _isOpened: isOpened,
        isWEB: _index6.default.getEnv() === _index6.default.ENV_TYPE.WEB
      };
      this.$$refs = [];
    }
  }, {
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index5.genCompid)(__prefix + "$compid__39"),
      ...
      var rootClass = (0, _index2.default)('at-modal', {
      ...
      if (title || content) {
        ...
        _$isRenderAction && propsManager.set({
          "isSimple": true
  ...
  return AtModal;
}(_component2.default), _class.$$events = ["handleClickOverlay", "handleCancel", "handleConfirm", "handleTouchMove"], _class.$$componentPath = "Users/duanhuiqian/Desktop/demo/trademapp/node_modules/taro-ui/dist/weapp/components/modal/index", _temp2);
...
Component(require('../../../../../_tarojs/taro-alipay/index.js').default.createComponent(AtModal));