...
var ReturnManagement = (_dec = (0, _index3.connect)(function (store) {
  ...
  function ReturnManagement() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReturnManagement.__proto__ || Object.getPrototypeOf(ReturnManagement)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__47", "$compid__48", "scrollHeight", "searchVal", "pageNo", "pageSize", "activeTabKey", "list", "tradeCounts"], _this.onPageChange = function (type, v) {
  ...
  _createClass(ReturnManagement, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index.genCompid)(__prefix + "$compid__47"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__47 = _genCompid2[0],
          $compid__47 = _genCompid2[1];

      var _genCompid3 = (0, _index.genCompid)(__prefix + "$compid__48"),
